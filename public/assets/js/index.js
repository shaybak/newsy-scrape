...
//   $(document).on("click", "#savey", handleArticleSave);
//   $(document).on("click", "#scrapey", handleArticleScrape);
//   $(document).on("click", "#cleary", handleArticleClear);
